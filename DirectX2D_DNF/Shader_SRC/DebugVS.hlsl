...
VSOut main(VSIn In)
{
    ...
    //In.Pos.y = In.Pos.y / cosh(0.78f);
    //WorldMatrix._12 = WorldMatrix._12 / float1(cosh(0.78f));
    //WorldMatrix._22 = WorldMatrix._22 / float1(cosh(0.78f));
    //WorldMatrix._32 = WorldMatrix._32 / float1(cosh(0.78f));
    //float dir = worldm._42 / abs(worldm._42);
    //worldm._12 = worldm._12 / (float) (cosh(0.7854f));
    //worldm._22 = worldm._22 / (float) (cosh(0.7854f));
    //worldm._32 = worldm._32 / (float) (cosh(0.7854f));
